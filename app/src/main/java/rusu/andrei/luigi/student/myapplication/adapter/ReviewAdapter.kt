package rusu.andrei.luigi.student.myapplication.adapter
...
import rusu.andrei.luigi.student.myapplication.model.Review
...
class ReviewAdapter (private val mReviews: List<Review>) : RecyclerView.Adapter<ReviewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val contactView = inflater.inflate(R.layout.review_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        textView.text = review.reviewerName
        ...
        textView1.text = review.description
        val textView3 = viewHolder.ratingTextView
        textView3.text = "★ ${review.rating}"
        val imageView = viewHolder.reviewImageView
        val bitmapFactoryOptions = BitmapFactory.Options()
        if(review.photo != null){
            imageView.setImageBitmap(BitmapFactory.decodeFile(review.photo?.absolutePath, bitmapFactoryOptions))
        }
